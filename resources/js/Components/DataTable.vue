        ...
        <tbody>
          <tr v-for="rowData in filteredData" :key="rowData.id">
            ...
            <td class="py-2 px-4 border-b h-full flex items-center justify-center  space-x-2">
              <!-- <button v-if="!rowData.editing" @click="edit(rowData)" class="delete-btn"></button>-->
              <button @click="edit(rowData)" class="edit-btn">
                <svg class="w-6 h-6 " viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                  ...
                  <g id="SVGRepo_iconCarrier">
                    <g fill="none" fill-rule="evenodd">
                      ...
                      <path
                        d="m30 2v28h-28v-28zm-7.7578644 5.01471863-10.5195936 10.51959357-3.23100596 6.0140781 5.97826226-3.1044801 10.6007644-10.60076445z"
                        fill="#056df5"></path>
                    </g>
                  </g>
                </svg>
              </button>
              <!--<button v-if="rowData.editing" @click="save(rowData)" class="text-green-600 hover:text-green-800">
              💾
            </button>-->

              <!-- Botón de eliminar fila -->
               <!--<div class="relative group inline-block">-->
                <button @click="deleteRow(rowData.id)" class="delete-btn">
                  <svg class="w-6 h-6 group-hover:opacity-80 transition" viewBox="0 0 511.999 511.999" fill="#000000">
                    <g id="SVGRepo_iconCarrier">
                      <circle style="fill:#E21B1B;" cx="255.999" cy="255.999" r="255.999"></circle>
                      <g>
                        <rect x="244.002" y="120.008"
                          transform="matrix(0.7071 -0.7071 0.7071 0.7071 -106.0397 256.0022)" style="fill:#FFFFFF;"
                          width="24" height="271.988"></rect>
                        <rect x="120.008" y="244.007"
                          transform="matrix(0.7071 -0.7071 0.7071 0.7071 -106.0428 256.0035)" style="fill:#FFFFFF;"
                          width="271.988" height="24"></rect>
                      </g>
                    </g>
                  </svg>
                </button>
