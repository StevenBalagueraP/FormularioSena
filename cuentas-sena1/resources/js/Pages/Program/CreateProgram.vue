<template>
    <div class="p-6 bg-gray-100 min-h-screen">
        ...
        <button 
            ...
            class="mb-4 bg-primary text-white px-4 py-2 rounded-md hover:bg-primary-dark"
        >
                ...
                <form @submit.prevent="submitForm" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="etapa_productiva" v-model="form.etapa_productiva" class="formulario-input" required>
                        </div>
                        <div>
                            <label for="duracion_total" class="formulario-label">Duración Total (horas)</label>
                            <input type="number" id="duracion_total" v-model="form.duracion_total" class="formulario-input" readonly>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="titulo_certificado" v-model="form.titulo_certificado" class="formulario-input" required>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <textarea id="justificacion" v-model="form.justificacion" rows="4" class="formulario-input" required></textarea>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 mt-6">
                        <button type="button" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400" @click="closeModal">
                            Cancelar
                        </button>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="mt-6">
                <h2 class="text-lg font-semibold mb-4">Lista de Programas</h2>
                <DataTableNew
                    :data="tableData"
                    :columns="columns"
...
const submitForm = () => {
    const lectiva = parseInt(form.value.etapa_lectiva) || 0;
    const productiva = parseInt(form.value.etapa_productiva) || 0;
    form.value.duracion_total = lectiva + productiva;
