                    ...
                    <tbody>
                        <tr v-for="item in data" :key="item.id" class="border-b">
                            ...
                            <td class="p-2 text-center">
                                <button
                                    class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-700">Editar</button>
                                <button
                                    class="bg-red-500 text-white px-3 py-1 rounded ml-2 hover:bg-red-700">Eliminar</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
